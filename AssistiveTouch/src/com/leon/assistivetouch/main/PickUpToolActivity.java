 ...
 * 最后更新者 $Author$
*/
public class PickUpToolActivity extends ListActivity{

	private PickUpToolsAdapter mAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		init();
		setContentView(R.layout.activity_pick_up_tool);
		initView();
	}
	...
	private KeyItemInfo getInfo (int key) {
		return KeyItemInfo.getKeyItemInfo(this, KeyItemInfo.TYPE_TOOL, String.valueOf(key));
	}
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		data.putExtra("type", KeyItemInfo.TYPE_TOOL);
	...
	private class PickUpToolsAdapter extends BaseAdapter {
		
		private LayoutInflater inflater;
		private List<KeyItemInfo> mList;
		public PickUpToolsAdapter (Context context, List<KeyItemInfo> list) {
