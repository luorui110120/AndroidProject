...
public class ToolsItemInfo {
	...
	public static final int KEY_SCREENSHOT = 10;
	
	public ToolsItemInfo () {}
	
	public ToolsItemInfo (Context context, String title, int icon, int type, String data) {
		this(title, context.getResources().getDrawable(icon), type, data);
	}
	
	public ToolsItemInfo (String title, Drawable icon, int type, String data) {
		this.title = title;
		this.icon = icon;
		this.type = type;
		this.data = data;
	...
	public static void doToolsEvent (String data) {
	...
	public static boolean isEquals (ToolsItemInfo info1, ToolsItemInfo info2) {
	...
	public static int getToolsResource (String data) {
	...
	public static ToolsItemInfo getToolsItemInfo (Context context, int type, String data) {
		...
		if (type == TYPE_APP) {
			...
			return new ToolsItemInfo(title, icon, type, data);
		}
		...
		return new ToolsItemInfo(context, title, res, type, data);
	}
}
